...
import com.lpg3.projeto1.config.customgrant.CustomPasswordAuthenticationConverter;
import com.lpg3.projeto1.config.customgrant.CustomPasswordAuthenticationProvider;
...
public class AuthorizationServerConfig {
	...
	public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer() {
		return context -> {
			...
			if ("access_token".equals(context.getTokenType().getValue()) && principal.getPrincipal() instanceof User) {
